...
const EditProfileForms = ({ backToProfile, profile }: EditProfileFormsProps) => {
  ...
  return (
    <Grid className={classes.container}>
      ...
      <Grid container>
        <Typography className={classes.subHeader}>Actualiza tu información personal aquí</Typography>
      </Grid>
      <FormProvider {...formMethods}>
        <Grid container justify="space-between">
          ...
          <Grid alignItems="flex-start" container item xs={6} className={classes.imageContainer}>
