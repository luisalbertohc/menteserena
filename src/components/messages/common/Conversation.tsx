...
import { CircularProgress, Grid, makeStyles, IconButton, Typography } from '@material-ui/core';
import { ArrowBack as ArrowBackIcon, Videocam as VideocamIcon, Warning as WarningIcon } from '@material-ui/icons';
...
const Conversation = ({
  ...
  const remaining_messages_for_patient = useSelector(
    (state: MessageProps) => state?.chat?.remaining_messages_for_patient
  );
